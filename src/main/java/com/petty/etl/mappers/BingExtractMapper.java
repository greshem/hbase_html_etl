...
import com.petty.etl.extractor.BingKnowsExtrctor;

import net.sf.json.JSONArray;
import net.sf.json.JSONObject;


public class BingExtractMapper extends TableMapper<Text, Text>{
	...
	protected void map(ImmutableBytesWritable key, Result value,
		...
		if(value != null){
			...
			BingKnowsExtrctor extractor = new BingKnowsExtrctor();
