...
import com.petty.etl.parser.FengoneParser;

import net.sf.json.JSONObject;

public class FengoneExtrctor extends BaseExtractor{
	...
	private List<JSONObject> parse(String srcurl, String html) {
		...
		if(srcurl.startsWith("http://bbs.fengone.com/")){
			result = FengoneParser.parser(html);
		}
