...
import com.petty.etl.mappers.ZhihuExtractCommentsMapper;
import com.hadoop.compression.lzo.DistributedLzoIndexer;
import com.hadoop.compression.lzo.LzopCodec;
import com.hadoop.mapreduce.LzoTextInputFormat;

public class ZhihuExtractCommentsDriver {
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJobName("extract_zhihu_comments");

		job.setJarByClass(ZhihuExtractCommentsDriver.class);
		job.setMapperClass(ZhihuExtractCommentsMapper.class);
