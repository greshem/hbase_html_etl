...
import com.petty.etl.mappers.ConvertHDFStoCSVMapper;

public class ConvertHDFStoCSVDriver {
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJobName("ConvertHDFStoCSV");

		job.setJarByClass(ConvertHDFStoCSVDriver.class);
		job.setMapperClass(ConvertHDFStoCSVMapper.class);
