...
import com.petty.etl.mappers.DoubanFillupMapper;
import com.petty.etl.reducers.DoubanFillupReducer;

public class DoubanFillupDriver{
	...
	public static void main(String[] args) throws Exception{
		...
		job.setJobName("Fillup_douban");
		
		//conf.set("hadoop.client.ugi", "root,supergroup");
		
		job.setJarByClass(DoubanFillupDriver.class); 
		job.setMapperClass(DoubanFillupMapper.class);
		job.setReducerClass(DoubanFillupReducer.class);
