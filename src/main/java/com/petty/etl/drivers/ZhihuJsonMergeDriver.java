...
import com.petty.etl.mappers.ZhihuJsonMergeMapper;
import com.petty.etl.reducers.ZhihuJsonMergeReducer;
import com.hadoop.compression.lzo.DistributedLzoIndexer;
import com.hadoop.compression.lzo.LzopCodec;
import com.hadoop.mapreduce.LzoTextInputFormat;

public class ZhihuJsonMergeDriver {
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(ZhihuJsonMergeDriver.class);

		job.setMapperClass(ZhihuJsonMergeMapper.class);
		job.setReducerClass(ZhihuJsonMergeReducer.class);
		job.setJobName("MergeQuestion_zhihujson");
