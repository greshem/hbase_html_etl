...
import com.petty.etl.mappers.GetIncrementalMapper;
import com.hadoop.compression.lzo.DistributedLzoIndexer;
import com.hadoop.compression.lzo.LzopCodec;
import com.hadoop.mapreduce.LzoTextInputFormat;

public class GetIncrementalDriver{
	...
	public static void main(String[] args) throws Exception{
		...
		job.setJobName("GetIncremental");
		
		
		job.setJarByClass(GetIncrementalDriver.class); 
		job.setMapperClass(GetIncrementalMapper.class);
